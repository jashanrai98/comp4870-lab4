    ...
    public class ProvinceController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var province = await _context.Provinces
                .FirstOrDefaultAsync(m => m.provCode == id);
            if (province == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("provCode,provName")] Province province)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("provCode,provName")] Province province)
        {
